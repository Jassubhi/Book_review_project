...
import requests
from flask import Flask, session, render_template, request, redirect, jsonify, flash, Markup
...
app.config["SECRET_KEY"] = "4dN4HapZVqtdijUcZzjGxFp0t40zeuEV1dvAav1g"
Session(app)
...
def book(isbn):
    ...
    url = "https://www.goodreads.com/book/isbn/{}?key=59bwYwhFe7jcg9BocgJCsg".format(isbn)
